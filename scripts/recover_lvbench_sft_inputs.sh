...
ORIGINAL="${LV_ORIGINAL_CANDIDATE:-results/eval/fast_hybrid_eva/frozen_direct/lvbench/lvbench_qwen_qwen3-5-9b-3e3c0499_direct_no_think_greedy_uniform32.jsonl}"
