    ...
    return (
        {
            ...
            "passed": agent_correct > direct_correct and errors <= len(ids) * 0.01 and leaks == 0 and reruns == 0,
...
def main() -> None:
    ...
    header = "| Dataset | Direct | Agent | Gain | 改对 | 改错 | Fallback | Errors | Visual Token | Total Token | Latency(s) | Pass |\n|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|\n"
    lines = [
        ...
        f"{item['fallback_to_candidate']} | {item['errors']} | "
    ...
    badcase_lines = ["# Direct正确但Agent改错\n"]
